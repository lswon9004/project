...
public interface ApprovalDao {
	...
	@Select({
	    ...
	    "<where>",
        	...
        	"and (approval_status1 = #{approval_status1} or approval_status2 = #{approval_status1})",
        "</if>",
	...
	@Select({
	    ...
	    "<where>",
	        ...
	        "</if>",
	        "<if test=\"approval_status1 != null and approval_status1 != ''\">",
            	"and (approval_status1 = #{approval_status1} and approver1_empno = #{approver1_empno})",
        	"or (approval_status2 = #{approval_status1} and approver2_empno = #{approver1_empno})",
        "</if>",
	        "and (approver1_empno = #{approver1_empno} or (approver2_empno = #{approver1_empno} and approval_status1 ='승인'))",
	    "</where>",
	    "</script>"
	})
	...
	@Select({
    	...
    	"or (approval_status2 = #{approval_status1} and approver2_empno = #{approver1_empno})",
    	"</if>",
	        "and (approver1_empno = #{approver1_empno} or (approver2_empno = #{approver1_empno} and approval_status1 ='승인')) order by created_date desc limit #{start} , 10",
	    "</where>",
	    "</script>"
	})
